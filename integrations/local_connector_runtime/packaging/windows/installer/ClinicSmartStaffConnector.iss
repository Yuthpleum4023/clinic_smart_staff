...
Source: "{#BuildRoot}\ClinicSmartStaffConnectorService.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#BuildRoot}\ClinicSmartStaffConnectorService.xml"; DestDir: "{app}"; Flags: ignoreversion
